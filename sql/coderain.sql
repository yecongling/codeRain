...
create table sys_dept (
  ...
  primary key (dept_id)
) engine=innodb auto_increment=200 charset=utf8 comment = '部门表';

-- ----------------------------
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '测试',   0, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '成都总公司', 1, '', '', '', '0', '0', 'admin', sysdate(), '', null);
...
insert into sys_dept values(108,  102, '0,100,101',  '市场部门',   1, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,101',  '财务部门',   2, '', '', '', '0', '0', 'admin', sysdate(), '', null);
