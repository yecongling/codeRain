package cn.ycl.common.utils.spring;
...
public class SprintUtils implements BeanFactoryPostProcessor, ApplicationContextAware {
     ...
     * @throws org.springframework.beans.BeansException bean异常
     */
    ...
    /**
     * 判断以给定名字注册的bean定义是一个singleton（单例）还是一个prototype（多例）。 如果与给定名字相应的bean定义没有被找到，将会抛出一个异常（NoSuchBeanDefinitionException）
     *
     * @param name 名
     * @return /
